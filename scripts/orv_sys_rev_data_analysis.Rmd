...
knitr::kable(studies_per_collab_type, caption = 'Number of studies by collaboration type',
             format = "latex", booktabs = TRUE) %>% 
        kableExtra::kable_styling(latex_options = c('striped', 'hold_position'))
```
...
knitr::kable(author_connectedness_to_location_aggreg, 
             caption = 'Studies with at least one author affiliation in the location studied (by collaboration type)', format = "latex", booktabs = TRUE) %>% 
        kableExtra::kable_styling(latex_options = c('striped', 'hold_position'))
```
