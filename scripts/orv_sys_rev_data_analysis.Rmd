...
1. How many publications per year?
2. Collaborations (aggregated)
3. Which countries are being studied? (author affiliation vs country studied)
...
collab_type_by_year_plot <- ggplot(data = collab_type_by_year) + 
  ...
  labs(title = 'Number of publications by collaboration type',
       x = 'Year',
...
#the long data
vax_vars_data_compact <- review_data_compact_cleaned %>% 
  select(paper_title, 
         publication_year,
         starts_with('disease'),
         outbreak_type,
