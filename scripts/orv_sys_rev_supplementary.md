...
![](orv_sys_rev_supplementary_files/figure-docx/unnamed-chunk-6-1.png)<!-- -->
...
|x0_reviewer | publication_year|paper_doi                                 |publication_type  |author_affiliation_type                               |country_studied |author_in_country_studied |disease   |objectives |individual_representation |space_representation |model_structure          |parametrization                                                               |validation          |outbreak_type         |intervention_modelled                                |vax_modelled_with_non_vax |is_vax_effective |modelling_timing |outcome_measured                                                  |sensitivity_analysis |data_used |data_available |simulation_code_available |title                                                                                                                                                                  |category |bibtexkey |author                                                                                                                                                                    |journal                          |month |number |pages      |publisher |volume | year|doi                          |language |vax_modelled |intervention_type | year_aggreg|collab_type     |
|:-----------|----------------:|:-----------------------------------------|:-----------------|:-----------------------------------------------------|:---------------|:-------------------------|:---------|:----------|:-------------------------|:--------------------|:------------------------|:-----------------------------------------------------------------------------|:-------------------|:---------------------|:----------------------------------------------------|:-------------------------|:----------------|:----------------|:-----------------------------------------------------------------|:--------------------|:---------|:--------------|:-------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------|:---------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------|:-----|:------|:----------|:---------|:------|----:|:----------------------------|:--------|:------------|:-----------------|-----------:|:---------------|
|james       |             2011|10.1371/journal.pone.0019515              |original_research |academic_institutions                                 |global          |not_applicable            |influenza |future     |compartments              |yes                  |stochastic               |values_from_literature                                                        |compared_with_data  |hypothetical_outbreak |vaccination                                          |no                        |not_applicable   |prospective      |attack_rate,outcome_other,prevalence                              |yes                  |yes       |yes            |yes                       |the global transmission and control of influenza                                                                                                                       |article  |Kenah2011 |Kenah, Eben           , Chao, Dennis L.       , Matrajt, Laura        , Halloran, M. Elizabeth, Longini, Ira M.                                                           |PLoS ONE                         |NA    |5      |NA         |NA        |6      | 2011|10.1371/journal.pone.0019515 |English  |yes          |vax_alongside     |        2011|purely_academic |
|elisha      |             2011|https://doi.org/10.1093/aje/kwq497        |original_research |academic_institutions + government_institutions + NGO |US              |yes                       |influenza |future     |compartments              |no                   |deterministic stochastic |values_from_literature values_fitted_to_ts                                    |compared_with_data  |real_outbreak         |vaccination                                          |yes                       |yes              |retrospective    |cases_averted,final_epidemic_size,timing_of_peak,hospitalizations |no                   |yes       |yes            |yes                       |planning for the control of pandemic influenza a (h1n1) in los angeles county and the united states                                                                    |article  |Chao2011  |Chao, D L        , Matrajt, L       , Basta, N E       , Sugimoto, J D    , Dean, B          , Bagwell, D A     , Oiulfstad, B     , Halloran, M E    , {Longini Jr}, I M |American Journal of Epidemiology |NA    |10     |1121--1130 |NA        |173    | 2011|NA                           |English  |yes          |vax_single        |        2011|mixed           |
|james       |             2015|https://doi.org/10.1007/s11538-015-0100-x |original_research |academic_institutions                                 |global          |not_applicable            |ebola     |future     |compartments              |yes                  |deterministic stochastic |values_from_literature values_from_guess_and_expert_opion values_fitted_to_ts |compared_with_data  |real_outbreak         |hygiene,isolation,intervention_other,hospitalization |no                        |not_applicable   |retrospective    |outcome_other,cumulative incidence, cumulative deaths             |yes                  |yes       |yes            |yes                       |be-codis: a mathematical model to predict the risk of human diseases spread between countries—validation and application to the 2014–2015 ebola virus disease epidemic |NA       |NA        |NULL                                                                                                                                                                      |NA                               |NA    |NA     |NA         |NA        |NA     |   NA|NA                           |NA       |no           |no_vax            |        2015|purely_academic |
